...
namespace InventoryClient.ViewModel
{
    class DeviceViewModel: BaseViewModel
    {
        ...
        private RelayCommand addDevCommand;
        public RelayCommand AddDevCommand
        {
            get
            {
                return addDevCommand ?? (addDevCommand = new RelayCommand(async obj =>
                {
        ...
        private RelayCommand updateDevCommand;
        public RelayCommand UpdateDevCommand
        {
            get
            {
                return updateDevCommand ?? (updateDevCommand = new RelayCommand(async (selectedItem) =>
                {
        ...
        private RelayCommand deleteDevCommand;
        public RelayCommand DeleteDevCommand
        {
            get
            {
                return deleteDevCommand ?? (deleteDevCommand = new RelayCommand(async (selectedItem) =>
                {
                    Device? device = selectedItem as Device;
                    if (device == null) return;
